package io.habitate.libs.postmark.client.data.model.server;
...
public class Server {
    ...
    public Boolean getEnableSmtpApiErrorHooks() {
        return enableSmtpApiErrorHooks;
    }

    public void setEnableSmtpApiErrorHooks(Boolean enableSmtpApiErrorHooks) {
