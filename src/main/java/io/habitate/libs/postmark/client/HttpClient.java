...
public class HttpClient {
    ...
    public ClientResponse execute(REQUEST_TYPES requestType, String url, String data) {
        var body = data == null ? HttpRequest.BodyPublishers.noBody() : HttpRequest.BodyPublishers.ofString(data);
        ...
        try {
            response = getClient().send(builder.build(), HttpResponse.BodyHandlers.ofString());
